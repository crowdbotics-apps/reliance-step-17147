"""reliance_step_17147 URL Configuration
...
admin.site.site_header = "Reliance Step"
admin.site.site_title = "Reliance Step Admin Portal"
admin.site.index_title = "Reliance Step Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Reliance Step API",
        default_version="v1",
        description="API documentation for Reliance Step App",
    ),
    public=True,
